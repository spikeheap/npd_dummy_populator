...
class App
  ...
  def build_pupil
    ...
    Ks2Pupil.new(
      ...
      candno: rand(9_999_999),
      matchref: SecureRandom.uuid[0...11],
      dcaref: SecureRandom.uuid[0...9],
      ndcref: SecureRandom.uuid[0...9],
      npdref: SecureRandom.uuid[0...9],
      checkref: rand(100_000), # Not in data tables, see KS2_NPDPT_Output_2016
      cand_id: academic_year == 2002 ? rand(999_999_999) : nil,
      ...
      plascdob: dob,
      yeargrp: rand(17),
      actyrgrp: (%w[N1 N2 R] + (1..14).to_a).sample,
      ethnic: ethnicity,
      ...
      sourcecty: %w[E W O].sample,
      langsch: %w[E W].sample,
      langmatta: %w[C E M].sample,
      langscita: %w[C E M].sample,
      endks: rand(2),
      enrolsts: %i[A C M S G O].sample, # see KS2_NPDPT_Output_2016
      preleae: rand(2_010_000..9_389_999),
      nentries: rand(1..4),
      ...
      readmrk: (%w[A IN M] + (0..50).to_a).sample,
      gpspaper1mrk: (%w[A IN M] + (0..50).to_a).sample,
      gpspaper2mrk: (%w[A IN M] + (0..20).to_a).sample,
      gpsmrk: (%w[A IN M] + (0..70).to_a).sample,
      matpaper2mrk: (%w[A IN M] + (0..35).to_a).sample,
      matpaper3mrk: (%w[A IN M] + (0..35).to_a).sample,
      matarithmrk: (%w[A IN M] + (0..40).to_a).sample,
      matmrk: (%w[A IN M] + (0..110).to_a).sample,
      ...
      engwritmrk: (%w[A IN M] + (0..50).to_a).sample,
      enghndwrmrk: ((0..5).to_a + ['_NV']).sample,
      engspellmrk: ((0..10).to_a + ['_NV']).sample,
      engtotmrk: (%w[A IN M] + (0..100).to_a).sample,
      ...
      mattestamrk: (%w[A IN M] + (0..40).to_a).sample,
      mattestbmrk: (%w[A IN M] + (0..40).to_a).sample,
      matarthmrk: (%w[A IN M] + (0..20).to_a).sample,
      mattotmrk: (%w[A IN M] + (0..100).to_a).sample,
      ...
      vaapsscore: rand(3..38),
      vaengscore: rand(3..38),
      vamatscore: rand(3..38),
      vaapspred1: rand(3..38),
      vaapspred: rand(3..38),
      vaengpred1: rand(3..38),
      vaengpred: rand(3..38),
      vaopred1: rand(3..38),
      vaopred: rand(3..38),
      vaoscore: rand(3..38),
      vamatpred1: rand(3..38),
      vamatpred: rand(3..38),
      vareadpred1: rand(3..38),
      vareadpred: rand(3..38),
      vareadscore: rand(3..38),
      vawrittapred1: rand(3..38),
      vawrittapred: rand(3..38),
      vawrittascore: rand(3..38),
      papssq: rand(3..38),
      pe_dev: rand(3..38),
      pr_dev: rand(3..38),
      pm_dev: rand(3..38),
      ...
      fsm6_cla: is_fsm || is_cla ? 1 : 0,
      fsm6cla1a: is_fsm || is_cla ? 1 : 0,
  ...
  def age_at(dob, _date_of_measurement)
